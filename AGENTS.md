...
- The Unload-container modifier (default U) + Left Drag transfers the dragged cargo-bearing container's direct cargo children to the release target while leaving the dragged container itself in place. This is direct Transfer semantics from the dragged container and is intentionally distinct from recursive/nested Unpack.
